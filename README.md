...
# 2. DSSR Data
The code base to prepare the DSSR data is stored on another repository called *RNAGlib* which has not been published yet. For now the most recent version of the data can be downloaded [here](https://mega.nz/file/xLhmSRDL#duH9kBk8WTpnrk1Pm6ylSVcjI5tjLtsnDrxVd96Fgh0)
