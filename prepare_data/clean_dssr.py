...
def print_component_info(g, i):
    ...
    if.json.is_connected(g):
        # print(pbid, i, ': connected')
        pass
    else:
        print("\n\n WARNING \n",
                pbid, i, ': not connected \t components:',.json.number_connected_components(g))
...
def main():
    ...
    connect_and_balance_all(args.interface_dir,
            args.native_dir, args.complement_dir,
                            args.output)
